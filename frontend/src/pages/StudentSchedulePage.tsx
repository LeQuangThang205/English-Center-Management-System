...
import { useStudentSchedule } from '@/features/schedule/useStudentSchedule';
...
export function StudentSchedulePage() {
  const { schedules, status, error, reload, from, to, setFrom, setTo } = useStudentSchedule();
  ...
  return (
    <div className={styles.page}>
      <PageHeader
        title="Lịch học"
        description="Lịch học của bạn trong khoảng thời gian đã chọn."
      />
      ...
      {status === 'loading' && <StudentScheduleSkeleton />}
...
function StudentScheduleSkeleton() {
  return (
    <div className={styles.skeletonList} aria-label="Đang tải lịch học" role="status">
